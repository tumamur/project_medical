...
python3 train.py --n_epoch 50 --batch_size 16 --update_freq 50 --use_float_reports --adaptive_threshold_gen --adaptive_threshold_disc --resume_training --resume_version 2
